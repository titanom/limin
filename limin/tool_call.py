...
async def generate_tool_call_completion_for_conversation(
    ...
    Args:
        ...
        tools: A list of Tool objects that define the available tools for the model.
        model_configuration: Optional configuration for the model. If None, uses the default configuration.

    Returns:
        A list of ToolCall objects representing the tool calls generated by the model.
    """
